...
class _RecordingScreenState extends ConsumerState<RecordingScreen> {
  String _place = kMeetingPlaces.first;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      await ref.read(recordingControllerProvider.notifier).setMeetingPlace(_place);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final placeValue =
        (rec.meetingPlace != null && kMeetingPlaces.contains(rec.meetingPlace))
            ? rec.meetingPlace!
            : _place;
